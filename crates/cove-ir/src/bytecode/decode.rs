...
pub fn decode(code: EncodedInst, pc: Pc) -> Result<Inst, Malformed> {
    ...
    Ok(match op {
        ...
        Op::RunSliceBytes => Inst::RunSlice {
            args: ArgsId(lo),
            storage: Storage::PackedBytes,
        },
        ...
        Op::GrowableAllocWords => Inst::GrowableAlloc {
            dst: a,
            capacity: b,
        ...
        Op::DynTypeName => Inst::DynTypeName { dst: a, view: b },
        Op::DynFieldName => Inst::DynFieldName {
            dst: a,
            view: b,
            index: c,
        },
        Op::DynCaseName => Inst::DynCaseName { dst: a, view: b },
        Op::DynOpaque => Inst::DynOpaque { dst: a, view: b },
        Op::DynHandleText => Inst::DynHandleText { dst: a, view: b },
        Op::DynOnPath => Inst::DynOnPath {
            dst: a,
            view: b,
            path: c,
        },
