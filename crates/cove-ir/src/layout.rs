...
pub enum Shape {
    ...
    /// [`crate::Inst::AllocBuffer`] allocates, [`crate::Inst::AppendByte`],
    /// [`crate::Inst::AppendBytes`] and [`crate::Inst::RunCopy`] fill, and
    /// [`crate::Inst::FinishBuffer`] turns into a `String` without copying. It is an
