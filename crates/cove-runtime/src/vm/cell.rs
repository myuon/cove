...
//! collect ([`crate::vm::mem::Space`]). It does not synchronise a *value*,
...
//! ([`crate::vm::mem::Memory::wait`]): it is not running, its frames do not
...
//!
//! # The layout is `cove-ir`'s
//!
//! [`Shape::Shared`](cove_ir::Shape::Shared) is the variant, and
//! [`cove_ir::SHARED_STATE`] and [`cove_ir::SHARED_VALUE`] are the two
