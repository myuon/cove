...
mod tests {
    ...
    fn a_report_prints_each_quantity_apart() {
        let report = BoundaryReport {
            ...
            intrinsics: vec![
                IntrinsicCalls {
                    intrinsic: Intrinsic::VectorContains,
                    sites: 1,
                    encoded: 1_000,
                    native: 7,
                },
                IntrinsicCalls {
                    intrinsic: Intrinsic::StringCodePointAtByte,
                    sites: 3,
                    encoded: 0,
                    native: 0,
                },
        ...
        assert!(text.contains("           1,000              7       1  Vector.contains"));
        assert!(text.contains("               0              0       3  String.codePointAtByte"));
    }
}
