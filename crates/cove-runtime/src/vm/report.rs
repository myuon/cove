...
pub struct HelperCalls {
    ...
    pub run_copy: u64,
    /// [`CopyBytesFn`](cove_native::CopyBytesFn): the byte copy under an append
    /// compiled code emitted. Not a crossing into anything that could stop or
    /// collect, but a call all the same.
    pub copy_bytes: u64,
